...
class AttributionReportingSourceRegistration:
    ...
    event_report_windows: typing.Optional[AttributionReportingEventReportWindows] = None
    ...
    def to_json(self):
        ...
        if self.event_report_windows is not None:
    ...
    def from_json(cls, json):
        return cls(
            ...
            event_report_windows=AttributionReportingEventReportWindows.from_json(json['eventReportWindows']) if 'eventReportWindows' in json else None,
